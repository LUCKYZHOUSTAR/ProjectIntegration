...
public class ReflectionUtils {
    ...
    public static Object invokeMethod(Object object, String methodName, Class<?>[] parameterTypes,
        ...
        try {
            ...
            LogUtils.error(logger, "invokeMethod %s process methodName:[%s] error[%s]. ", object,
    ...
    public static void setFieldValue(Object object, String fieldName, Object value) {
        ...
        try {
            ...
            LogUtils.error(logger, "setFieldValue %s process fieldName:[%s] error[%s]. ", object,
    ...
    public static Object getFieldValue(Object object, String fieldName) {
        ...
        try {
            ...
            LogUtils.error(logger, "getFieldValue %s process fieldName:[%s] error[%s]. ", object,
                fieldName, e.getMessage());
        }
    ...
    public static void main(String[] args) {
        ...
        ReflectionUtils.writeField("httpServiceReload", test, "aa");
